...
Airline_Data<- read.csv("C:/datasciences/asssignments/Forecasting/Airlines+Data.csv")
View(Airline_Data) # Seasonality 12 months 
hist(Airline_Data$Passengers) #positively skewed
summary(Airline_Data$Passengers)

# Treating data into Time-Series data
passenger <- ts(Airline_Data,frequency = 12)
cycle(passenger)  #it shows the period of 12 months
boxplot(passenger ~ cycle(passenger), xlab="Passenger Numbers ('000)", ylab="Months", col = rgb(0.1,0.9,0.3,0.4), main="Monthly Air Passengers Boxplot from 1995 to 2002", horizontal=FALSE, notch=FALSE)
#over period of time the no of passengers is increasing
...
rmse_linear
# Accuracy in terms of rmse is 53.2 which is very high
...
rmse_expo 
# Accuracy of the model in terms of rmse is 46.06 decrease slightly here
######################### Quadratic ####################################
...
rmse_Quad 
# Accuracy of the model in terms of rmse is 48.05 high value of rmse
...
rmse_sea_add
# Accuracy of the model in terms of 132.8 which is very high
...
# R^2 value is observed to be 0.96 which is very good
...
rmse_multi_sea
# Accuracy of the model in terms of rmse is 140.06 very high
...
#CONCLUSION :
# Model of Multiplicative seasonality with linear trend is found to be 
